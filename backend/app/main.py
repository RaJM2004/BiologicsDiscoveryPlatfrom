...
from app.api import auth, targets, screening, experiments, optimization, admin
...
# app.include_router(chatbot.router, prefix="/api/chat", tags=["Chatbot"]) - Need to import it first
